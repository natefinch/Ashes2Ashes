...
ACMD(do_grep)
{
  ...
  struct grep_struct {
    ...
    { "rip",		LVL_IMMORT },
    { "errors",		LVL_CIMP },
    { "newplayers",	LVL_IMMORT },			/* 5 */
    { "badpws",		LVL_IMMORT },
    { "godcmds",	LVL_CIMP },
    { "delete",		LVL_IMMORT },
    { "levels",		LVL_IMMORT },
    { "restarts",	LVL_IMMORT },			/* 10 */
    { "reimb",		LVL_ASST },
    { "syslog",		LVL_IMMORT },
    { "syslog1",	LVL_IMMORT },
    { "syslog2",	LVL_IMMORT },
    { "syslog3",	LVL_IMMORT },			/* 15 */
    { "syslog4",	LVL_IMMORT },
    { "syslog5",	LVL_IMMORT },
    { "syslog6",	LVL_IMMORT },
    { "buildlog",	LVL_ASST },
    { "buildlog1",	LVL_ASST },			/* 20 */
    { "buildlog2",	LVL_ASST },
    { "buildlog3",	LVL_ASST },
    { "buildlog4",	LVL_ASST },
    { "buildlog5",	LVL_ASST },
    { "buildlog6",	LVL_ASST },			/* 25 */
    { "buildcmds",	LVL_ASST },
    { "builderrs",	LVL_ASST },
    { "dupe",		LVL_IMMORT },
    { "\n", }
  ...
  case 1:
    ...
    break;
  case 2:
    fp=fopen("../log/loots", "r");
    break;
  case 3:
    fp=fopen("../log/rip", "r");
    break;
  case 4:
    fp=fopen("../log/errors", "r");
    break;
  case 5:
    fp=fopen("../log/newplayers", "r");
    break;
  case 6:
    fp=fopen("../log/badpws", "r");
    break;
  case 7:
    fp=fopen("../log/godcmds", "r");
    break;
  case 8:
    fp=fopen("../log/delete", "r");
    break;
  case 9:
    fp=fopen("../log/levels", "r");
    break;
  case 10:
    fp=fopen("../log/restarts", "r");
    break;
  case 11:
    fp=fopen("../log/reimb", "r");
    break;
  case 12:
    fp=fopen("../syslog", "r");
    break;
  case 13:
    fp=fopen("../log/syslog.1", "r");
    break;
  case 14:
    fp=fopen("../log/syslog.2", "r");
    break;
  case 15:
    fp=fopen("../log/syslog.3", "r");
    break;
  case 16:
    fp=fopen("../log/syslog.4", "r");
    break;
  case 17:
    fp=fopen("../log/syslog.5", "r");
    break;
  case 18:
    fp=fopen("../log/syslog.6", "r");
    break;
  case 19:
    fp=fopen("../buildlog", "r");
    break;
