...
#define QBRED CCRED(ch,C_SPR)
#define QBGRN CCGRN(ch,C_SPR)
#define QBYEL CCYEL(ch,C_SPR)
#define QBBLU CCBLU(ch,C_SPR)
#define QBMAG CCMAG(ch,C_SPR)
#define QBCYN CCCYN(ch,C_SPR)
#define QBWHT CCWHT(ch,C_SPR)

#define VC_CHANNAME_COL "\x1B[1m\x1B[31m"
#define VC_CHARNAME_COL "\x1B[0m\x1B[36m"
#define VC_TEXT_COL "\x1B[0m\x1B[33m"
#define VC_EMOTE_COL "\x1B[0m\x1B[33m"
#define VC_ACT_COL "\x1B[0m\x1B[33m"
