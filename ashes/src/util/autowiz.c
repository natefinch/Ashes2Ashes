...
void write_wizlist(FILE * out, int minlev, int maxlev)
{
  ...
  if(maxlev >= LVL_CIMP) {
    fprintf(out,
"****************************************************************************\n"
"* The following people have reached immortality on Ashes to Ashes.  They   *\n"
"* are to be treated with respect and awe.  Occasional prayers to them are  *\n"
...
"****************************************************************************\n\n");
    ...
    fprintf(out,
"****************************************************************************\n"
"* These are new immortals who have not yet proven themselves. They are     *\n"
"* here to help just like all immortals, but may not know how to handle     *\n"
"* every situation, so be patient with them.                                *\n"
"****************************************************************************\n\n");
  }
